...
extension Entry {
    ...
    public class func sampleData(for context: NSManagedObjectContext) throws -> Set<Entry> {
        ...
        Entry(
                ...
                project: projects.first { $0.path == "ACME/Transmogrifier"})
        Entry(
                context,
                ...
                project: projects.first { $0.path == "ACME/Transmogrifier" },
                tags: tags.filter { $0.path == "Secret" })
        Entry(
                context,
                ...
                project: projects.first { $0.path == "Tailspin Toys" },
                tags: tags.filter { $0.path == "Client Work" })
        Entry(
                context,
                ...
                project: projects.first { $0.path == "ACME/Froobnicator" },
                tags: tags.filter { $0.path == "Secret" })
        Entry(
                context,
                name: "Conference call",
                ...
                project: projects.first { $0.path == "ACME/Froobnicator" },
                tags: tags.filter { $0.path == "Secret" || $0.path == "Client Work" })
        Entry(
                context,
                ...
                project: projects.first { $0.path == "Contoso/Chronos" })
        Entry(
                context,
                name: "Touch base",
                interval: DateInterval(
